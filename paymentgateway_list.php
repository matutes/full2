...
$con->query("update payment_list set img='".$url."',status=".$status.",cred_title='".$ctitle."',cred_value='".$cvalue."' where id=".$_GET['edit']."");
 
}
else 
{
    $con->query("update payment_list set status=".$status.",cred_title='".$ctitle."',cred_value='".$cvalue."' where id=".$_GET['edit']."");
}
?>
